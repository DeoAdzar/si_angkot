...
class ParentTrackingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Obx(() {
        // Check if the student data is null
        print(
            "Tracking: studentTrackingId: ${controller.studentTrackingId.value}");
        print("Tracking: latitude: ${controller.latitude.value}");
        print("Tracking: longitude: ${controller.longitude.value}");
        ...
        return Stack(
          children: [
            ...
            Positioned(
              ...
              child: Container(
                padding:
                    EdgeInsets.only(top: 40, left: 8, right: 16, bottom: 10),
                    ...
                    Container(
                      ...
                      child: Obx(() {
                        return Row(
                          children: [
                            _buildTab(
                                'Status', 0, controller.selectedTabIndex.value),
                            _buildTab('History', 1,
